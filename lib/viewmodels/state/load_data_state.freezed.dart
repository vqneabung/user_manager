...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadDataState<T>);
}
...
/// @nodoc
class $LoadDataStateCopyWith<T,$Res>  {
$LoadDataStateCopyWith(LoadDataState<T> _, $Res Function(LoadDataState<T>) __);
}


/// Adds pattern-matching-related methods to [LoadDataState].
extension LoadDataStatePatterns<T> on LoadDataState<T> {
...
class _Initial<T> implements LoadDataState<T> {
  const _Initial();
...
@override
String toString() {
  return 'LoadDataState<$T>.initial()';
}
...
class _Loading<T> implements LoadDataState<T> {
  const _Loading();
...
@override
String toString() {
  return 'LoadDataState<$T>.loading()';
}
...
class _Success<T> implements LoadDataState<T> {
...
@override
String toString() {
  return 'LoadDataState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $LoadDataStateCopyWith<T, $Res> {
...
class _Error<T> implements LoadDataState<T> {
...
@override
String toString() {
  return 'LoadDataState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $LoadDataStateCopyWith<T, $Res> {
